            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="nav-item">
                <a
                  ...
                  href="#pablo"
                >
                  <i className="fab fa-twitter text-lg leading-lg text-white opacity-75"></i><span className="ml-2">Products</span>
                </a>
              </li>
              <li className="nav-item">
                <a
              ...
              <li className="nav-item">
                <a
                  ...
                  href="#pablo"
                >
                  <i className="fab fa-pinterest text-lg leading-lg text-white opacity-75"></i><span className="ml-2">Branches</span>
                </a>
              </li>
            </ul>
          </div>
